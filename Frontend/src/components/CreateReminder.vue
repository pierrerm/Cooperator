    ...
    <div class="site-wrap">
      <div class="site-section" style="padding-top:10%">
        <div class="container" style="align:center">
          <h1 class="page-title">Create New Reminder</h1>

          <div class="half left" id="table">
            <table class="info-table" style="width: 90%; height: 100%;">
              <div>
                <tr>
                  <th style="padding:10px;width: 300px">Subject</th>
                  <td style="padding:10px">{{ reminder.Subject }}</td>
                </tr>
                <tr>
...
<script src="./javascript/createReminder.js">
</script>
