...
import ViewGroup6EmployerCoops from '@/components/ViewGroup6EmployerCoops'
...
let router = new Router({
  routes: [
    ...
    {
      path: '/studentCoopGroup9',
      name: 'ViewGroup6EmployerCoops',
      component: ViewGroup6EmployerCoops,
      meta:{
        requiresAuth: true
      }
    }
